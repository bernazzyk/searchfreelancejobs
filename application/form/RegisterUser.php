...
class Application_Form_RegisterUser extends Zend_Form 
{
    ...
    { 
		...
		$f_password_confirm->setLabel('Confirm Password')
						  ->setRequired(true)
						  ->addFilter('StripTags')
						  ->addFilter('StringTrim')
						  ->addValidator('NotEmpty');
    ...
    ;
        ...
        $f_submit->setLabel('Submit');
         ...
         $this->addElements(array($f_firstName, $f_lastName,$f_companyName,$f_country, $f_street,$f_state,$f_post_code,$f_email, /*$f_password,*/ $f_userName,$f_password, $f_password_confirm, $f_submit));
	}
}
?>