<?php
	...
	//	protected $UrlLink = 'http://freelancer.fm';
	//	protected $UrlLink = 'http://freelancer.fm';
		...
		{
				$url_for_profile = 'https://www.odesk.com/api/auth/v1/info.json';
				$url_for_profile_xml = 'https://www.odesk.com/api/auth/v1/info.xml';
				
				$doc1 = new DOMDocument();
				$doc1->load($url_for_profile_xml);
				$xpath = new DOMXpath($doc1);
				
				$ProjectItems = $xpath->query("response");
				print_r($ProjectItems);
				//die('ok');
				
				$modelFromGeneral = new Application_Model_General();
				$modelFromGeneral->cURLExtractJSONContent($url_for_profile); //(json_decode($json_txt, true));
		...
		public function odeskAction()
		{
			...
			$callbackUrl = SITE_URL . 'auth/odeskcallback/'; // callback url, full url to your script, e.g. http://localhost/oauth.php
		...
		public function odeskcallbackAction()
			session_start();
			require_once('Odesk/OdeskConfig.php');
			$curent_url =  $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];
			parse_str(parse_url($curent_url, PHP_URL_QUERY), $_MY_GET);
		...
		public function odeskBackupAction()
		{
			session_start();
			...
			//$consumerSec = '5e722d5383eff298'; // consumer secret, got in console with key
			$sigMethod   = 'HMAC-SHA1'; // signature method, e.g. HMAC-SHA1
			$callbackUrl = 'http://freelancer.fm/auth/odesk/'; // callback url, full url to your script, e.g. http://localhost/oauth.php
			//$url         = 'https://www.odesk.com/services/api/keys/a42d40a24fe99df1466bb781ce13c4ac'; // api's url, e.g. http://www.odesk.com/api/mc/v1/threads/my_odesk_uid/22222.json (see MC documentation)
			$url         = 'https://www.odesk.com/services/api/keys/'; // api's url, e.g. http://www.odesk.com/api/mc/v1/threads/my_odesk_uid/22222.json (see MC documentation)
			...
			//$my_arr=array('oauth_token'=>'05403920be355069a3f2ba9af2764299','oauth_verifier'=>'463429436c3d0465421b5b7b6d09b70b');
			...
			if (!empty($_SESSION['ACCESS_TOKEN'])) {
				...
				$api_sig = md5('6c21f6884bcbd3ccapi_key8f3e8ef823d8a928240d48309f1cf054api_token069f8e76bbf30e740a9a4d09d40dbb2fonlinealltzmine');
				print '---'.$api_sig; die;
				
				'https://www.odesk.com/api/team/v1/teamrooms/odeskdev?online=all&tz=mine&api_key=8f3e8ef823d8a928240d48309f1cf054&api_token=069f8e76bbf30e740a9a4d09d40dbb2f&api_sig=dc30357f7c6b62aadf99e5313ac93365';
	...
	public function loginajaxAction()
    {
		...
		//	$session = new Zend_Session_Namespace('redirection');
			...
			//$curent_url = "http://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
		//	print $curent_url; die;
			
			parse_str(parse_url($curent_url, PHP_URL_QUERY), $r);
			//print_r($array);
			//die;
			//print_r( parse_url($curent_url)); die;
			
			//print $curent_url; die;
			
			//print $_REQUEST['oauth_verifier']; die;
