...
final class OdeskApi {
    ...
    const URL_LOGIN     = 'https://www.odesk.com/login.php';
    ...
    private $api_token  = null,
            $api_secret = null,
            $callback   = 'http://freelancer.fm/odesk/example.php', //null, //'http://freelancer.fm/odesk/example.php',
            $mode       = 'web',
	...
	{
		self::$api_token = '463044c8ddce56fa507f26ac58c33f8f';
		self::$api_secret = 'ff52a1cc8e6e29d1';
    ...
    public function searchProjects( $params = array( ) )
    {
        $url = 'http://www.odesk.com/api/profiles/v1/search/jobs.json';
