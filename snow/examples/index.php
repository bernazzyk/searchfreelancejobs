...
if (!isset ($_SESSION['access_key']) && !isset($_GET['token'])) {
	...
	echo '<a href="'.$stl->getAuthorizeURL().'">Authorize with Freelancer.com</a><br>OR<br/>';
	echo '<a href="index.php?token=0a212e90474434730e54442a56e5f4611ddb2b60&secret=6e5f96949f1118263900be4224418fdc8aba8728">Use stltest001\'s Access toket</a>';
}else{
	if(isset($_GET['token'])){
	//die('ascasc');
	...
	//$_SESSION['access_key'] = array('oauth_token'=>$_SESSION['token']['oauth_token'],'oauth_token_secret'=>$_SESSION['token']['oauth_token_secret']);
...
//	$stl->setFormat('json');
	...
	//print_r($_SESSION['accountDetail']); 
	...
	case 'getPendingFeedback':
		...
		break;
	case 'getUserDetails':
		$stl->getUserDetails(array('username'=>'vw7573432vw'));//work
		break;
