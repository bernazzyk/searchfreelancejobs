...
class ElanceAuthentication {
    ...
    private function InitCurl($url) {
		...
		$cookieFile = '/var/www/clients/client1/web1/web/yta/application/controllers/cookies/44cookie.txt';
		curl_setopt ($r, CURLOPT_COOKIEFILE, $cookieFile); 
		curl_setopt ($r, CURLOPT_COOKIEJAR, $cookieFile);
